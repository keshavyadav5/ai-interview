...
import { BotIcon, ChartArea, ChartBar, Clock, File, FileArchive, Mic, Sparkle } from 'lucide-react'
...
const card = [
  ...
  },
  {
    ...
    desc: "Role interview pressure with time tracking."
  },
]
const image = [
  {
  ...
  },
  {
    ...
    title: "Download Based Interview",
  ...
  },
  {
    ...
    desc: 'Track progress with performance graphics and topic analytics.'
  },
...
const modes = [
  ...
  },
  {
    ...
    desc: "Based tone and voice analytics insights."
  },
  {
    img: creditImg,
      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-6xl mx-auto'>
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-sm px-4 my-2 rounded-full flex items-center gap-2'>
              <Sparkle size={18} className='bg-green-50 text-green-600' />
          ...
          <div className='text-center mb-28'>
            ...
            >
              ...
              <span className='relative inline-block mt-1'>
                <span className='bg-green-100 text-green-600 px-5 py-1 rounded-xl'>
                  AI Intelligence
                </span>
              </span>
            </motion.h1>
